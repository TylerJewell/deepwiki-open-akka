...
[AsyncFuncAI/deepwiki-open](https://github.com/AsyncFuncAI/deepwiki-open) and recording what it does, not by translating its
source. See `../deepwiki-open-port/specs/SPEC-001-deepwiki-open.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for the
...
## The interface — MIT, as AsyncFuncAI/deepwiki-open licensed it

- `gui/`

That code was written by the AsyncFuncAI/deepwiki-open project, Copyright 2024 Sheing Ng, and is shipped
here **verbatim**, reused rather than rebuilt, per this harness's RENDERING.md R3. It
remains under the licence its authors chose, unmodified, in `LICENSE-deepwiki-open` and beside
